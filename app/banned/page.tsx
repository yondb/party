...
export default function BannedPage() {
  return (<div className="mx-auto flex min-h-dvh max-w-md flex-col justify-center px-6 py-12 text-center">
      <h1 className="text-2xl font-bold text-[var(--status-full)]">Account suspended</h1>
